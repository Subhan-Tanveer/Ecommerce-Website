...
const backendUrl =import.meta.env.VITE_BACKEND_URL
  ...
  const isAdmin = () => {
    ...
    return token && (role === 'admin' || role === 'vendor')
  }
...
const getUserCart = async (token) =>{
  try {
    ...
    if (response.data.success) {
      ...
      // User was deleted — clear stale token
...
useEffect (()=>{
  getProductsData();
  getCategoriesData();
  // Re-fetch products whenever the tab regains focus so price/qty changes reflect immediately
  const onFocus = () => getProductsData()
